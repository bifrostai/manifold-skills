...
| Skill | What it does |
|---|---|
| [`setup-manifold`](skills/setup-manifold/SKILL.md) | Set up a project for Manifold: gather what the wrap and container steps will need, and write it to `.manifold/CONTEXT.md`. Three phases: look at the project, interview, write CONTEXT.md. |
